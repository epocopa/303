...
public class MostrarGrupoCommand implements Command{
	...
	public Context execute(Object datos) {
		...
		try{
			...
			return new Context(EventosGrupo.MOSTRAR_GRUPO_OK, grupo);

		} catch(Exception e){
			mensaje = e.getMessage();
			return new Context(EventosGrupo.MOSTRAR_GRUPO_KO, mensaje);
		}
	}
}