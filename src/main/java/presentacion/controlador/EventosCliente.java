...
public class EventosCliente {
	...
	public static final int MODIFICAR_BUSCAR_CLIENTE = 6;	// Para modificar un CLIENTE, primero tenemos que buscar si está, o no en la BBDD.

	// Eventos para actualizar la vista si la operación se ha realizado correctamente (_OK) o incorrectamente (_KO).
	
	public static final int REGISTRAR_CLIENTE_OK = 0;
	public static final int REGISTRAR_CLIENTE_KO = 1;
