...
public class EventosTurno {
	...
	public static final int MODIFICAR_BUSCAR_TURNO = 31; // Para modificar un
															// TURNO, primero
															// tenemos que
															// buscar si esta, o
															// no en la BBDD.

	// Eventos para actualizar la vista si la operacion se ha realizado
	// correctamente (_OK) o incorrectamente (_KO).
